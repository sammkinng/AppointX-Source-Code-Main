...
export const transMailBookingNew = {
    subject: "Email notification of booking progress at AppointY",
    template: (data) => {
        return `<h3>Thank you for booking an appointment at AppointY </h3>
        ...
        <h4>AppointY will automatically send email notification when confirmed appointment is complete. Thank you !</h4>`;
    },
};
...
export const transMailRemedy = {
    ...
    template: (data) => {
        return `<h3>Thank you for your trust in booking a medical examination in AppointY</h3>
        ...
        <br>
        <div>For example: Full name: Prince, with the registered phone number: 0123456789 and born: 2000, the extracted password is: <b> abcdefhg-012-10 </b> </div>
        <br>
