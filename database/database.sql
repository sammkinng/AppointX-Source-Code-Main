...
-- Database: `AppointY`
--
CREATE DATABASE IF NOT EXISTS `AppointY` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `AppointY`;
...
(1, 'admin - Prince', 'admin@gmail.com', '$2a$07$Bq0hCq3kVrvKUHfMT0NJROmQkx09aEQkGlwBGEdw799YJvWqH1kuy', 'Rohtak', '08983983', 'admin.png', 'male', NULL, 1, 1, '2020-11-13 19:44:36', '2020-11-13 19:44:36', NULL);
COMMIT;
